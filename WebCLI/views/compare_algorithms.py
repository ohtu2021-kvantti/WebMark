...
class AlgorithmComparisonView(AlgorithmViewBase):
    ...
    def _get_common_molecules(self, version1, version2):
    ...
    def get(self, request, a1_id, a2_id):
        ...
        (av1, av2) = self._get_selected_versions(params, versions1, versions2)
        params["version1_id"] = av1.pk if av1 else None
        params["version2_id"] = av2.pk if av2 else None
        common_molecules = self._get_common_molecules(av1, av2)
